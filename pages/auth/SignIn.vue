<template>
  <div class="flex flex-col justify-center h-dvh px-6 py-12 lg:px-8">
    <div class="block lg:hidden pt-4 pr-5 pl-5 absolute top-0 left-0">
      <NuxtLink to="/welcome" class="font-sans font-sm"><svg class="w-10 h-10 p-2  bg-zinc-800 rounded-lg hover:bg-zinc-700" viewBox="0 0 512 512" version="1.1"
    ...
    <div class="mt-7 sm:mx-auto sm:w-full sm:max-w-md flex flex-col">
      <form class="space-y-5" @submit.prevent="submitForm">
        <div>
          <label for="email" class="block text-sm font-medium leading-5">Эл. почта</label>
          <div class="mt-1">
...
export default defineComponent({
  ...
  methods: {
    ...
    submitForm() {
      console.log('Form submitted:', { emailLogin: this.emailLogin, password: this.password });
    }
  }
});
</script>
