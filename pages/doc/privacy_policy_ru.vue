<template>
  <div class="pt-10 pb-10 pl-2 pb-2">
    ...
    <p>1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее – Политика) применяется ко
      всей информации, которую Оператор может получить о посетителях веб-сайта <NuxtLink
      to="https://ota-ku.ru" class="text-blue-500">https://ota-ku.ru</NuxtLink></p>
    <br>
    <h2 class="text-xl">2. Основные понятия, используемые в Политике</h2>
    <br>
    ...
    <p>2.3. Веб-сайт – совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных,
      обеспечивающих их доступность в сети интернет по сетевому адресу <NuxtLink
      to="https://ota-ku.ru" class="text-blue-500">https://ota-ku.ru</NuxtLink>;</p>
    ...
    <p>2.8. Персональные данные – любая информация, относящаяся прямо или косвенно к определенному или определяемому
      Пользователю веб-сайта <NuxtLink
      to="https://ota-ku.ru" class="text-blue-500">https://ota-ku.ru</NuxtLink>;</p>
    <p>2.9. Пользователь – любой посетитель веб-сайта <NuxtLink
      to="https://ota-ku.ru" class="text-blue-500">https://ota-ku.ru</NuxtLink>;</p>
    ...
    <br>
    <h2 class="text-xl">3. Оператор может обрабатывать следующие персональные данные Пользователя</h2>
    <br>
    ...
    <br>
    <h2 class="text-xl">4. Цели обработки персональных данных</h2>
    <br>
    ...
    <br>
    <h2 class="text-xl">5. Правовые основания обработки персональных данных</h2>
    <br>
    <p>5.1. Оператор обрабатывает персональные данные Пользователя только в случае их заполнения и/или отправки
      Пользователем самостоятельно через специальные формы, расположенные на сайте <NuxtLink
        to="https://ota-ku.ru" class="text-blue-500">https://ota-ku.ru</NuxtLink>. Заполняя соответствующие формы и/или отправляя свои
    ...
    <br>
    <h2 class="text-xl">6. Порядок сбора, хранения, передачи и других видов обработки персональных данных</h2>
    <br>
    ...
    <p>6.4. Срок обработки персональных данных является неограниченным. Пользователь может в любой момент отозвать
      ...
      данных».</p>
    <br>
    <h2 class="text-xl">7. Трансграничная передача персональных данных</h2>
    <br>
    ...
    <br>
    <h2 class="text-xl">8. Заключительные положения</h2>
    <br>
    <p>8.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его
      персональных данных, обратившись к Оператору с помощью электронной почты <a
        href="mailto:w33bv.gl@gmail.com" class="text-blue-500">w33bv.gl@gmail.com</a>.</p>
    ...
    <p>8.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу <NuxtLink class="text-blue-500"
        to="/doc/privacy_policy_ru">https://otaku/doc/privacy_policy_ru.php</NuxtLink>.</p>
  </div>
</template>
<script>
</script>