<template>
  <div class="pt-10 pb-10 pr-2 pl-2">
        <h1 class="text-2xl">Пользовательское Соглашение</h1>
        <br>
        ...
        <br>
        <h2 class="text-xl">Предмет соглашения</h2>
        <br>
        ...
        <br>
        <h2 class="text-xl">Права и обязанности сторон</h2>
        <br>
        ...
        <br>
        <h2 class="text-xl">Обязанности Администрации</h2>
        <br>
        ...
        <br>
        <h2 class="text-xl">Ответственность сторон</h2>
        <ul>
        ...
        <br>
        <h2 class="text-xl">Условия действия Соглашения</h2>
        <br>
